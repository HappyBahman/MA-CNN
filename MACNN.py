...
def vis(draw_imgs=2):
    ...
    for idx, (data, label) in enumerate(dataloader_val):
        ...
        for b in range(B):
            ...
            ax2.imshow(feat_maps_numpy,cmap="jet")

            ax3 = fig.add_subplot(5,4,5)
            ax3.stem(np.arange(512), t1)
            ax4 = fig.add_subplot(5,4,6)
            ax4.stem(np.arange(512), t1)
            ax5 = fig.add_subplot(5,4,7)
            ax5.stem(np.arange(512), t3)
            ax6 = fig.add_subplot(5,4,8)
            ax6.stem(np.arange(512), t4)

            ax7 = fig.add_subplot(5,4,9)
            ax7.stem(np.arange(512), t1_)
            ax8 = fig.add_subplot(5,4,10)
            ax8.stem(np.arange(512), t2_)
            ax9 = fig.add_subplot(5,4,11)
            ax9.stem(np.arange(512), t3_)
            ax10 = fig.add_subplot(5,4,12)
            ax10.stem(np.arange(512), t4_)

            ax11 = fig.add_subplot(5,4,13)
            ax11.imshow(feat_maps1_numpy)
            ax12 = fig.add_subplot(5,4,14)
            ax12.imshow(feat_maps2_numpy)
            ax13 = fig.add_subplot(5,4,15)
            ax13.imshow(feat_maps3_numpy)
            ax14 = fig.add_subplot(5,4,16)
            ax14.imshow(feat_maps4_numpy)

            ax15 = fig.add_subplot(5, 4, 17)
            ax15.imshow(feat_maps1_numpy_)
            ax16 = fig.add_subplot(5, 4, 18)
            ax16.imshow(feat_maps2_numpy_)
            ax17 = fig.add_subplot(5, 4, 19)
